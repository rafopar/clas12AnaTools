...
void Draw_calibr()
{
  ...
  const double SLM_slope = 15968.466;
  const double SLM_offset = -13201.903;
  ...
  tr1->ReadFile("SLM_Calibr_BB_out.dat", "S2b:S16b:IPM2C21A:IPM2C24A");
  ...
  TH1D *h_2C21_fCup_ratio2 = new TH1D("h_2C21_fCup_ratio2", "", 200, 0.95, 1.15);
  ...
  for( int i = 0; i < n1; i++ ){
    ...
    if( IPM2C21A >  0.9*IFcup && IPM2C21A <  1.1*IFcup ){
      ...
      if( IPM2C21A > 20 ){
	h_2C21_fCup_ratio2->Fill(IPM2C21A/IFcup);
      }
  ...
  gr_SLM_Fcup_bbout->Fit(f_lin1, "MeV", "", 1, 80.);
  ...
  gr_2c21_Fcup_bbout->Fit(f_lin1, "MeV", "", 1, 80.);
  ...
  double mean = h_2C21_fCup_ratio1->GetMean();
  double rms = h_2C21_fCup_ratio1->GetRMS();
  f_Gaus->SetParameters(h_2C21_fCup_ratio1->GetMaximum(), mean, rms);
  h_2C21_fCup_ratio1->Fit(f_Gaus, "MeV", "", mean - 0.9*rms, mean + 0.9*rms);
  ...
  ofstream out_2c21_dat("2C21_fits.dat");
  TCanvas *c_22 = new TCanvas("c_22", "", 900, 900);
  c_22->SetTopMargin(0.02);
  c_22->SetRightMargin(0.02);
  c_22->SetBottomMargin(0.18);
  c_22->cd();
  h_2C21_fCup_ratio2->GetXaxis()->SetNdivisions(506);
  h_2C21_fCup_ratio2->SetAxisRange(1., 1.11, "X");
  h_2C21_fCup_ratio2->SetTitle("; I_{2C21}/I_{FCup}");
  h_2C21_fCup_ratio2->GetXaxis()->CenterTitle();
  h_2C21_fCup_ratio2->SetLabelSize(0.075, "Y");
  h_2C21_fCup_ratio2->SetLabelSize(0.075, "X");
  h_2C21_fCup_ratio2->SetTitleSize(0.075, "X");
  h_2C21_fCup_ratio2->SetLabelOffset(0.015, "Y");
  h_2C21_fCup_ratio2->SetLabelOffset(0.02, "X");
  h_2C21_fCup_ratio2->SetTitleOffset(1.2);
  h_2C21_fCup_ratio2->SetStats(0);
  h_2C21_fCup_ratio2->Draw();
  mean = h_2C21_fCup_ratio2->GetMean();
  rms = h_2C21_fCup_ratio2->GetRMS();
  f_Gaus->SetParameters(h_2C21_fCup_ratio2->GetMaximum(), mean, rms);
  h_2C21_fCup_ratio2->Fit(f_Gaus, "MeV", "", mean - 0.9*rms, mean + 0.9*rms);
  out_2c21_dat<<"======== The I_2C21/I_FCup ratio ========"<<endl;
  out_2c21_dat<<"Meam = "<<f_Gaus->GetParameter(1)<<setw(15)<<"   Sigma = "<<f_Gaus->GetParameter(2)<<endl;
  c_22->Print("fCup_2C21_ratio_highcurr.pdf");
  ...
  line1->DrawLine(0., scale_2C21, 80., scale_2C21);
  c1->Print("Beam_current_figures.pdf");
  ...
  gr_2c24_Fcup_bbout->Fit(f_lin1, "MeV", "", 1, 80.);
  lat1->DrawLatex(0.14, 0.85, "F = a + b*I_{FCup}");
  lat1->DrawLatex(0.14, 0.8, Form("a = %1.3f #pm %1.3f nA",  f_lin1->GetParameter(0), f_lin1->GetParError(0)));
  lat1->DrawLatex(0.14, 0.75, Form("b = %1.4f #pm %1.4f ", f_lin1->GetParameter(1), f_lin1->GetParError(1) ));
  //  lat1->DrawLatex(0.14, 0.7, Form("#chi^{2}/NDF = %1.3f ", f_lin1->GetChisquare()/f_lin1->GetNDF()));
  ...
  mean = h_2C24_fCup_ratio1->GetMean();
  rms = h_2C24_fCup_ratio1->GetRMS();
  f_Gaus->SetParameters(h_2C24_fCup_ratio1->GetMaximum(), mean, rms);
  h_2C24_fCup_ratio1->Fit(f_Gaus, "MeV", "", mean - 0.9*rms, mean + 0.9*rms);
  ...
  line1->DrawLine(0., scale_2C24, 80., scale_2C24);
  c1->Print("Beam_current_figures.pdf");
  ...
  TH1D *h_2C21_fCup_ratio_bbin1 = new TH1D("h_2C21_fCup_ratio_bbin1", "", 200, 9., 10.5);
  TH1D *h_2C21_fCup_ratio_bbin2 = new TH1D("h_2C21_fCup_ratio_bbin2", "", 200, 9., 10.5);
  TH1D *h_2C24_fCup_ratio_bbin1 = new TH1D("h_2C24_fCup_ratio_bbin1", "", 200, 9., 10.5);
  ...
  tr2->ReadFile("SLM_Calibr_BB_in.dat", "S2b:S16b:IPM2C21A:IPM2C24A");
  ...
  for( int i = 0; i < n1; i++ ){
    ...
    if( IPM2C21A*0.08 < IFcup && IPM2C21A*0.12 > IFcup ){
      ...
      if( IPM2C21A > 20 ){
	h_2C21_fCup_ratio_bbin2->Fill(IPM2C21A/IFcup);
      }
  ...
  gr_2c21_Fcup_bbin->Fit(f_lin1, "MeV", "", 1, 80.);
  lat1->DrawLatex(0.14, 0.85, "F = a + b*I_{FCup}");
  ...
  mean = h_2C21_fCup_ratio_bbin1->GetMean();
  rms = h_2C21_fCup_ratio_bbin1->GetRMS();
  f_Gaus->SetParameters(h_2C21_fCup_ratio_bbin1->GetMaximum(), mean, rms);
  h_2C21_fCup_ratio_bbin1->Fit(f_Gaus, "MeV", "", mean - 0.9*rms, mean + 0.9*rms);
  ...
  c_22->cd();
  h_2C21_fCup_ratio_bbin2->SetTitle("; I_{2C21}/I_{FCup}");
  h_2C21_fCup_ratio_bbin2->SetAxisRange(9.57, 10.15, "X");
  h_2C21_fCup_ratio_bbin2->SetLabelSize(0.075, "Y");
  h_2C21_fCup_ratio_bbin2->GetXaxis()->CenterTitle();
  h_2C21_fCup_ratio_bbin2->SetLabelSize(0.075);
  h_2C21_fCup_ratio_bbin2->SetTitleSize(0.075);
  h_2C21_fCup_ratio_bbin2->SetLabelOffset(0.015, "Y");
  h_2C21_fCup_ratio_bbin2->SetLabelOffset(0.02, "X");
  h_2C21_fCup_ratio_bbin2->SetTitleOffset(1.2);
  h_2C21_fCup_ratio_bbin2->SetStats(0);
  h_2C21_fCup_ratio_bbin2->Draw();
  mean = h_2C21_fCup_ratio_bbin2->GetMean();
  rms = h_2C21_fCup_ratio_bbin2->GetRMS();
  f_Gaus->SetParameters(h_2C21_fCup_ratio_bbin2->GetMaximum(), mean, rms);
  h_2C21_fCup_ratio_bbin2->Fit(f_Gaus, "MeV", "", mean - 1.02*rms, mean + 0.9*rms);

  out_2c21_dat<<"======== The I_2C21/I_FCup ratio with BeamBlocker ========"<<endl;
  out_2c21_dat<<"Meam = "<<f_Gaus->GetParameter(1)<<setw(15)<<"   Sigma = "<<f_Gaus->GetParameter(2)<<endl;
  
  c_22->Print("BB_attenuation_2c21_highcurr.pdf");

  c1->cd();
  c1->Clear();
  gr_2c21_Fcup_ratio_bbin->GetYaxis()->SetTitleOffset(1.2);
  gr_2c21_Fcup_ratio_bbin->SetMaximum(10.8);
  ...
  line1->DrawLine(0., attenuation_2C21, 80., attenuation_2C21);
  c1->Print("BB_attenuation.pdf");
  ...
  gr_2c24_Fcup_bbin->Fit(f_lin1, "MeV", "", 1, 80.);
  lat1->DrawLatex(0.14, 0.85, "F = a + b*I_{FCup}");
  lat1->DrawLatex(0.14, 0.8, Form("a = %1.4f #pm %1.4f nA", f_lin1->GetParameter(0), f_lin1->GetParError(0)));
  lat1->DrawLatex(0.14, 0.75, Form("b = %1.4f #pm %1.4f", f_lin1->GetParameter(1), f_lin1->GetParError(1) ));
  ...
  mean = h_2C24_fCup_ratio_bbin1->GetMean();
  rms = h_2C24_fCup_ratio_bbin1->GetRMS();
  f_Gaus->SetParameters(h_2C24_fCup_ratio_bbin1->GetMaximum(), mean, rms);
  h_2C24_fCup_ratio_bbin1->Fit(f_Gaus, "MeV", "", mean - 0.9*rms, mean + 0.9*rms);
  ...
  gr_2c24_Fcup_ratio_bbin->SetMaximum(10.8);
  ...
  line1->DrawLine(0., attenuation_2C24, 80., attenuation_2C24);
  c1->Print("BB_attenuation.pdf");
