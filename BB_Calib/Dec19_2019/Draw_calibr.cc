...
void Draw_calibr()
{
  ...
  const double Imax = 45.; // Max currrent that was used
  ...
  const double fCup_offsetBBOut = 218.;
  ...
  tr1->ReadFile("Dec19_2019_FullTarg_BBOut.dat", "S2b:S16b:IPM2C21A:IPM2C24A");
  ...
  for( int i = 0; i < n1; i++ ){
    ...
    double IFcup = (S2b - fCup_offsetBBOut)/fCup_slope;
  ...
  TH1D *h_2C21_fCup_ratio_bbin1 = new TH1D("h_2C21_fCup_ratio_bbin1", "", 200, 8., 22.);
  TH1D *h_2C24_fCup_ratio_bbin1 = new TH1D("h_2C24_fCup_ratio_bbin1", "", 200, 8., 22.);

  const double fCup_offsetBBIn = 231.;
  ...
  tr2->ReadFile("Dec19_2019_FullTarg_BBIn.dat", "S2b:S16b:IPM2C21A:IPM2C24A");
  ...
  for( int i = 0; i < n2; i++ ){
    ...
    double IFcup = (S2b - fCup_offsetBBIn)/fCup_slope;
    
    IPM2C24A = IPM2C24A/scale_2C24;
    
    if( IPM2C24A*0.069 < IFcup && IPM2C24A*0.08 > IFcup ){
    ...
    if( IPM2C21A*0.069 < IFcup && IPM2C21A*0.08 > IFcup ){
  ...
  gr_2c21_Fcup_ratio_bbin->SetMaximum(15.);
  gr_2c21_Fcup_ratio_bbin->SetMinimum(11.);
  ...
  gr_2c24_Fcup_ratio_bbin->SetMaximum(15.);
  gr_2c24_Fcup_ratio_bbin->SetMinimum(11.);
