...
void Draw_calibr()
{
  ...
  const double Imax = 65.; // Max currrent that was used
  ...
  tr1->ReadFile("Ld2_Dec15_2021_5p99_BBOut_50nA.dat", "S2b:S16b:IPM2C21A:IPM2C24A");
  ...
  tr2->ReadFile("Ld2_Dec15_2021_5p99_BBIn_50nA.dat", "S2b:S16b:IPM2C21A:IPM2C24A");
