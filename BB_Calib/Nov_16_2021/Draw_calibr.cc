...
void Draw_calibr()
{
  ...
  const double Imax = 55.; // Max currrent that was used
  ...
  tr1->ReadFile("LD2_Nov16_2021_5p99GeV_BBOut.dat", "S2b:S16b:IPM2C21A:IPM2C24A");
  ...
  tr2->ReadFile("LD2_Nov16_2021_5p99GeV_BBIn.dat", "S2b:S16b:IPM2C21A:IPM2C24A");
