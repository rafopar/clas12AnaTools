...
void Draw_calibr()
{
  ...
  const double Imax = 170.; // Max currrent that was used
  ...
  tr1->ReadFile("Empty_Feb_02_6GeV_BBOut.dat", "S2b:S16b:IPM2C21A:IPM2C24A");
  ...
  TH1D *h_2C21_fCup_ratio_bbin1 = new TH1D("h_2C21_fCup_ratio_bbin1", "", 200, 15., 19.);
  TH1D *h_2C24_fCup_ratio_bbin1 = new TH1D("h_2C24_fCup_ratio_bbin1", "", 200, 15., 19.);
  ...
  tr2->ReadFile("Empty_Feb_02_6GeV_BBIn.dat", "S2b:S16b:IPM2C21A:IPM2C24A");
  ...
  for( int i = 0; i < n2; i++ ){
    ...
    if( IPM2C24A*0.05 < IFcup && IPM2C24A*0.09 > IFcup && IPM2C24A > Imin ){
    ...
    if( IPM2C21A*0.05 < IFcup && IPM2C21A*0.09 > IFcup && IPM2C21A > Imin ){
  ...
  gr_2c21_Fcup_ratio_bbin->SetMaximum(19.);
  gr_2c21_Fcup_ratio_bbin->SetMinimum(15.);
  ...
  gr_2c24_Fcup_ratio_bbin->SetMaximum(19.);
  gr_2c24_Fcup_ratio_bbin->SetMinimum(15.);
