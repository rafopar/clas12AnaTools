...
void Draw_calibr()
{
  ...
  const double Imin = 20.; // Max currrent used in the callibration
  ...
  tr1->ReadFile("Ca48_Feb_04_6GeV_BBOut.dat", "S2b:S16b:IPM2C21A:IPM2C24A");
  ...
  tr2->ReadFile("Ca48_Feb_04_6GeV_BBIn.dat", "S2b:S16b:IPM2C21A:IPM2C24A");
