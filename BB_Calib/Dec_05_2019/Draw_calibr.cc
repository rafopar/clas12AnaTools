...
void Draw_calibr()
{
  ...
  const double fCup_offset = 109.6;
  ...
  tr1->ReadFile("Dec05_2019_10p4_EmptyTarg_BBOut.dat", "S2b:S16b:IPM2C21A:IPM2C24A");
  ...
  tr2->ReadFile("Dec05_2019_10p4_EmptyTarg_BBIn.dat", "S2b:S16b:IPM2C21A:IPM2C24A");
