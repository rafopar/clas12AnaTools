...
void Draw_calibr()
{
  ...
  const double Imax = 85.; // Max currrent that was used
  ...
  tr1->ReadFile("Nov11_2021_5p99GeV_BBOut.dat", "S2b:S16b:IPM2C21A:IPM2C24A");
  ...
  tr2->ReadFile("Nov11_2021_5p99GeV_BBIn.dat", "S2b:S16b:IPM2C21A:IPM2C24A");
