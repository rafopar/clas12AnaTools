...
void Draw_calibr()
{
  ...
  tr1->ReadFile("RGD_Empty_BBOut.dat", "S2b:S16b:IPM2C21A:IPM2C24A");
  ...
  TH1D *h_2C21_fCup_ratio_bbin1 = new TH1D("h_2C21_fCup_ratio_bbin1", "", 200, 6., 12.);
  TH1D *h_2C24_fCup_ratio_bbin1 = new TH1D("h_2C24_fCup_ratio_bbin1", "", 200, 6., 12.);
  ...
  tr2->ReadFile("RGD_Empty_BBIn.dat", "S2b:S16b:IPM2C21A:IPM2C24A");
  ...
  for( int i = 0; i < n2; i++ ){
    ...
    if( IPM2C24A*0.08 < IFcup && IPM2C24A*0.25 > IFcup && IPM2C24A > Imin ){
    ...
    if( IPM2C21A*0.08 < IFcup && IPM2C21A*0.25 > IFcup && IPM2C21A > Imin ){
