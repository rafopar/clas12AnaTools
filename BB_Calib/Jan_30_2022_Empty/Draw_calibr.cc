...
void Draw_calibr()
{
  ...
  tr1->ReadFile("Empty_Jan_30_4p03_BBOut.dat", "S2b:S16b:IPM2C21A:IPM2C24A");
  ...
  tr2->ReadFile("Empty_Jan_30_4p03_BBIn.dat", "S2b:S16b:IPM2C21A:IPM2C24A");
