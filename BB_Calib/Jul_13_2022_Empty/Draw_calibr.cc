...
void Draw_calibr()
{
  ...
  const double Imax = 20.; // Max currrent that was used
  const double Imin = 2.; // Max currrent used in the callibration
  ...
  tr1->ReadFile("Empty_July_13_10p55GeV_BBOut.dat", "S2b:S16b:IPM2C21A:IPM2C24A");
  ...
  TH1D *h_2C21_fCup_ratio_bbin1 = new TH1D("h_2C21_fCup_ratio_bbin1", "", 200, 8., 14.);
  TH1D *h_2C24_fCup_ratio_bbin1 = new TH1D("h_2C24_fCup_ratio_bbin1", "", 200, 8., 14.);
  ...
  tr2->ReadFile("Empty_July_13_10p55GeV_BBIn.dat", "S2b:S16b:IPM2C21A:IPM2C24A");
  ...
  for( int i = 0; i < n2; i++ ){
    ...
    if( IPM2C24A*0.05 < IFcup && IPM2C24A*0.2 > IFcup && IPM2C24A > Imin ){
    ...
    if( IPM2C21A*0.05 < IFcup && IPM2C21A*0.2 > IFcup && IPM2C21A > Imin ){
  ...
  gr_2c21_Fcup_ratio_bbin->SetMinimum(8.);
  ...
  gr_2c24_Fcup_ratio_bbin->SetMinimum(8.);
