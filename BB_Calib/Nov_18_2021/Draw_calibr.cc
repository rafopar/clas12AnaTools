...
void Draw_calibr()
{
  ...
  tr1->ReadFile("He4_Nov18_2021_5p99GeV_BBOut.dat", "S2b:S16b:IPM2C21A:IPM2C24A");
  ...
  tr2->ReadFile("He4_Nov18_2021_5p99GeV_BBIn.dat", "S2b:S16b:IPM2C21A:IPM2C24A");
