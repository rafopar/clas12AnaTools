...
void Draw_calibr()
{
  ...
  tr1->ReadFile("Sn_Dec5_2021_5p99_BBOut.dat", "S2b:S16b:IPM2C21A:IPM2C24A");
  ...
  TH1D *h_2C21_fCup_ratio_bbin1 = new TH1D("h_2C21_fCup_ratio_bbin1", "", 200, 6., 10.);
  TH1D *h_2C24_fCup_ratio_bbin1 = new TH1D("h_2C24_fCup_ratio_bbin1", "", 200, 6., 10.);
  ...
  tr2->ReadFile("Sn_Dec5_2021_5p99_BBIn.dat", "S2b:S16b:IPM2C21A:IPM2C24A");
  ...
  for( int i = 0; i < n2; i++ ){
    ...
    if( IPM2C24A*0.1 < IFcup && IPM2C24A*0.16 > IFcup ){
    ...
    if( IPM2C21A*0.1 < IFcup && IPM2C21A*0.16 > IFcup ){
  ...
  gr_2c21_Fcup_ratio_bbin->SetMinimum(6.);
  ...
  gr_2c24_Fcup_ratio_bbin->SetMinimum(6.);
