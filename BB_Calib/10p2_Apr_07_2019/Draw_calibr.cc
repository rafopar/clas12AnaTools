...
void Draw_calibr()
{
  ...
  tr1->ReadFile("10p2_Apr_07_2019_BB_Out.dat", "S2b:S16b:IPM2C21A:IPM2C24A");
 ...
 gr_2c21_Fcup_bbout->SetTitle("2C21 ;I_{FCup} [nA]; I_{2C21} [nA]");
  ...
  tr2->ReadFile("10p2_Apr_07_2019_BB_In.dat", "S2b:S16b:IPM2C21A:IPM2C24A");
