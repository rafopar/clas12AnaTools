...
void Draw_FCup_SLM(){
  ...
  tr_S2b->ReadFile("Scaler_S2b_Data_15_Dec_2017_BB_In.dat", "t_S2b:count_S2b");
  ...
  tr_S16b->ReadFile("Scaler_S16b_Data_15_Dec_2017_BB_In.dat", "t_S16b:count_S16b");
  ...
  gr_SLM_calibr_DataTaking->GetXaxis()->SetLimits(0., 45.);
