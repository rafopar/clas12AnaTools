...
void Draw_calibr()
{
  ...
  const double Imax = 52; // Max currrent that was used
  ...
  tr1->ReadFile("6p6_GeV_SLM_Calibr_BB_out.dat", "S2b:S16b:IPM2C21A:IPM2C24A");
 ...
 gr_2c21_Fcup_bbout->SetTitle("2C21 ;I_{FCup} [nA]; I_{2C21} [nA]");
  ...
  tr2->ReadFile("6p6_GeV_SLM_Calibr_BB_in.dat", "S2b:S16b:IPM2C21A:IPM2C24A");
