...
void Draw_calibr()
{
  ...
  const double SLM_slope = 7679.;
  const double SLM_offset = -3779.;
  // const double SLM_slope = 8796.;
  ...
  const double fCup_offset = 113.5;
  ...
  tr1->ReadFile("Dec04_2019_10p4_FullTarg_BBOut.dat", "S2b:S16b:IPM2C21A:IPM2C24A");
  ...
  tr2->ReadFile("Dec04_2019_10p4_FullTarg_BBIn.dat", "S2b:S16b:IPM2C21A:IPM2C24A");
  ...
  gr_2c21_Fcup_ratio_bbin->SetMaximum(11.);
  ...
  gr_2c24_Fcup_ratio_bbin->SetMaximum(11.);
