...
void Draw_calibr()
{
  ...
  const double Imax = 220.; // Max currrent that was used
  ...
  tr1->ReadFile("RGD_CuSn_BBOut.dat", "S2b:S16b:IPM2C21A:IPM2C24A");
  ...
  TH1D *h_2C21_fCup_ratio_bbin1 = new TH1D("h_2C21_fCup_ratio_bbin1", "", 200, 4., 8.);
  TH1D *h_2C24_fCup_ratio_bbin1 = new TH1D("h_2C24_fCup_ratio_bbin1", "", 200, 4., 8.);
  ...
  tr2->ReadFile("RGD_CuSn_BBIn.dat", "S2b:S16b:IPM2C21A:IPM2C24A");
  ...
  for( int i = 0; i < n2; i++ ){
    ...
    if( IPM2C24A*0.125 < IFcup && IPM2C24A*0.5 > IFcup && IPM2C24A > Imin ){
    ...
    if( IPM2C21A*0.125 < IFcup && IPM2C21A*0.5 > IFcup && IPM2C21A > Imin ){
  ...
  gr_2c21_Fcup_ratio_bbin->SetMaximum(10.);
  gr_2c21_Fcup_ratio_bbin->SetMinimum(4.);
  ...
  gr_2c24_Fcup_ratio_bbin->SetMaximum(10.);
  gr_2c24_Fcup_ratio_bbin->SetMinimum(4.);
