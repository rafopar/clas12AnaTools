...
void Draw_2C21_SLM(){
  ...
  const double t_start_DataTaking = 1515951529; // Beginning of Data Taking
  const double t_End_DataTaking = 1515954525.49;   // End of Data Taking
  ...
  tr_S16b->ReadFile("ScalerS16b_01_15_2018_3.dat", "t_S16b:count_S16b");
  ...
  tr_2C21->ReadFile("2C21_01_15_2018_3.dat", "t_2C21:count_2C21");
  ...
  for( int i = 0; i < n_2C21; i++ ){
    ...
    while( t_S16b_arr[S16b_index] < t_2C21 ){
      ...
      if( S16b_index > 5 && S16b_index < n_S16b - 6 ){
        if( count_S16b_arr[S16b_index - 5] < 0.0333 && count_S16b_arr[S16b_index - 4] < 0.0333 && count_S16b_arr[S16b_index - 3] < 0.0333
            && count_S16b_arr[S16b_index - 2] < 0.0333 && count_S16b_arr[S16b_index - 1] < 0.0333 && count_S16b_arr[S16b_index] > 0.0333
            && count_S16b_arr[S16b_index + 1] > 0.0333 && count_S16b_arr[S16b_index + 2] > 0.0333 && count_S16b_arr[S16b_index + 3] > 0.0333
            && count_S16b_arr[S16b_index + 4] > 0.0333 ){
      ...
      //cout<<"FCup_curr["<<S16b_index<<"] = "<<FCup_curr<<endl;
