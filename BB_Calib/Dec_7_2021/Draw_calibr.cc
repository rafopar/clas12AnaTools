...
void Draw_calibr()
{
  ...
  tr1->ReadFile("Ca48_Dec5_2021_5p99_BBOut.dat", "S2b:S16b:IPM2C21A:IPM2C24A");
  ...
  tr2->ReadFile("Ca48_Dec5_2021_5p99_BBIn.dat", "S2b:S16b:IPM2C21A:IPM2C24A");
