...
void Draw_calibr()
{
  ...
  const double Imax = 150; // Max currrent that was used
  
  const double SLM_slope = 18543.639;
  const double SLM_offset = -13108.485;
  ...
  tr1->ReadFile("7p5_GeV_SLM_FCUP_Calibr_BB_out.dat", "S2b:S16b:IPM2C21A:IPM2C24A");
 ...
 gr_2c21_Fcup_bbout->SetTitle("2C21 ;I_{FCup} [nA]; I_{2C21} [nA]");
  ...
  TH1D *h_2C21_fCup_ratio_bbin1 = new TH1D("h_2C21_fCup_ratio_bbin1", "", 200, 14., 18.);
  TH1D *h_2C24_fCup_ratio_bbin1 = new TH1D("h_2C24_fCup_ratio_bbin1", "", 200, 14., 18.);
  ...
  tr2->ReadFile("7p5_GeV_SLM_FCUP_Calibr_BB_in.dat", "S2b:S16b:IPM2C21A:IPM2C24A");
  ...
  for( int i = 0; i < n2; i++ ){
    ...
    if( IPM2C24A*0.05 < IFcup && IPM2C24A*0.08 > IFcup ){
    ...
    if( IPM2C21A*0.05 < IFcup && IPM2C21A*0.08 > IFcup ){
  ...
  gr_2c21_Fcup_ratio_bbin->SetMaximum(18.);
  gr_2c21_Fcup_ratio_bbin->SetMinimum(14.);
  ...
  gr_2c24_Fcup_ratio_bbin->SetMaximum(18.);
  gr_2c24_Fcup_ratio_bbin->SetMinimum(14.);
