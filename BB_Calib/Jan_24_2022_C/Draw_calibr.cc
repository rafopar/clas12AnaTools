...
void Draw_calibr()
{
  ...
  const double Imax = 110.; // Max currrent that was used
  ...
  tr1->ReadFile("C_Jan_24_4p03_BBOut.dat", "S2b:S16b:IPM2C21A:IPM2C24A");
  ...
  tr2->ReadFile("C_Jan_24_4p03_BBIn.dat", "S2b:S16b:IPM2C21A:IPM2C24A");
