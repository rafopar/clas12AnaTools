...
void Draw_calibr()
{
  ...
  const double Imax = 25.; // Max currrent that was used
  ...
  tr1->ReadFile("Ar_Jan_27_4p03_BBOut.dat", "S2b:S16b:IPM2C21A:IPM2C24A");
  ...
  TH1D *h_2C21_fCup_ratio_bbin1 = new TH1D("h_2C21_fCup_ratio_bbin1", "", 200, 3., 5.);
  TH1D *h_2C24_fCup_ratio_bbin1 = new TH1D("h_2C24_fCup_ratio_bbin1", "", 200, 3., 5.);
  ...
  tr2->ReadFile("Ar_Jan_27_4p03_BBIn.dat", "S2b:S16b:IPM2C21A:IPM2C24A");
  ...
  for( int i = 0; i < n2; i++ ){
    ...
    if( IPM2C24A*0.2 < IFcup && IPM2C24A*0.4 > IFcup && IPM2C24A > Imin ){
    ...
    if( IPM2C21A*0.2 < IFcup && IPM2C21A*0.4 > IFcup && IPM2C21A > Imin ){
  ...
  gr_2c21_Fcup_ratio_bbin->SetMaximum(5.);
  gr_2c21_Fcup_ratio_bbin->SetMinimum(3.);
  ...
  gr_2c24_Fcup_ratio_bbin->SetMaximum(5.);
  gr_2c24_Fcup_ratio_bbin->SetMinimum(3.);
