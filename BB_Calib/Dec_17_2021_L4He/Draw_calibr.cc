...
void Draw_calibr()
{
  ...
  const double Imax = 75.; // Max currrent that was used
  const double Imin = 15.; // Max currrent that was used
  ...
  tr1->ReadFile("L4He_Dec17_2021_5p99_BBOut.dat", "S2b:S16b:IPM2C21A:IPM2C24A");
  ...
  for( int i = 0; i < n1; i++ ){
    ...
    cout<<"KUKU    IPM2C24A  = "<<IPM2C24A<<"    IFCup = "<<IFcup<<"     S2b = "<<S2b<<endl;
  ...
  TH1D *h_2C21_fCup_ratio_bbin1 = new TH1D("h_2C21_fCup_ratio_bbin1", "", 200, 12., 18.);
  TH1D *h_2C24_fCup_ratio_bbin1 = new TH1D("h_2C24_fCup_ratio_bbin1", "", 200, 12., 18.);
  ...
  tr2->ReadFile("L4He_Dec17_2021_5p99_BBIn.dat", "S2b:S16b:IPM2C21A:IPM2C24A");
  ...
  for( int i = 0; i < n2; i++ ){
    ...
    if( IPM2C24A*0.04 < IFcup && IPM2C24A*0.09 > IFcup && IPM2C24A > Imin ){
    ...
    if( IPM2C21A*0.04 < IFcup && IPM2C21A*0.09 > IFcup && IPM2C21A > Imin ){
  ...
  gr_2c21_Fcup_ratio_bbin->SetMinimum(12.);
  ...
  gr_2c24_Fcup_ratio_bbin->SetMinimum(12.);
