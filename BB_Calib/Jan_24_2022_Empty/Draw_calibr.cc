...
void Draw_calibr()
{
  ...
  const double Imax = 90.; // Max currrent that was used
  const double Imin = 35.; // Max currrent used in the callibration
  ...
  tr1->ReadFile("Empty_Jan_24_2p07_BBOut.dat", "S2b:S16b:IPM2C21A:IPM2C24A");
  ...
  TH1D *h_2C21_fCup_ratio_bbin1 = new TH1D("h_2C21_fCup_ratio_bbin1", "", 200, 22., 28.);
  TH1D *h_2C24_fCup_ratio_bbin1 = new TH1D("h_2C24_fCup_ratio_bbin1", "", 200, 22., 28.);
  ...
  tr2->ReadFile("Empty_Jan_24_2p07_BBIn.dat", "S2b:S16b:IPM2C21A:IPM2C24A");
  ...
  for( int i = 0; i < n2; i++ ){
    ...
    if( IPM2C24A*0.01 < IFcup && IPM2C24A*0.09 > IFcup && IPM2C24A > Imin ){
    ...
    if( IPM2C21A*0.01 < IFcup && IPM2C21A*0.09 > IFcup && IPM2C21A > Imin ){
  ...
  gr_2c21_Fcup_ratio_bbin->SetMaximum(28.);
  gr_2c21_Fcup_ratio_bbin->SetMinimum(22.);
  ...
  gr_2c24_Fcup_ratio_bbin->SetMaximum(28.);
  gr_2c24_Fcup_ratio_bbin->SetMinimum(22.);
