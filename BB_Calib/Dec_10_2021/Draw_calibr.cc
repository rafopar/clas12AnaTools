...
void Draw_calibr()
{
  ...
  const double Imax = 160.; // Max currrent that was used
  const double Imin = 20.; // Max currrent that was used
  ...
  tr1->ReadFile("Ca40_Dec10_2021_5p99_BBOut.dat", "S2b:S16b:IPM2C21A:IPM2C24A");
  ...
  TH1D *h_2C21_fCup_ratio_bbin1 = new TH1D("h_2C21_fCup_ratio_bbin1", "", 200, 10., 15.);
  TH1D *h_2C24_fCup_ratio_bbin1 = new TH1D("h_2C24_fCup_ratio_bbin1", "", 200, 10., 15.);
  ...
  tr2->ReadFile("Ca40_Dec10_2021_5p99_BBIn.dat", "S2b:S16b:IPM2C21A:IPM2C24A");
  ...
  for( int i = 0; i < n2; i++ ){
    ...
    if( IPM2C24A*0.06 < IFcup && IPM2C24A*0.1 > IFcup && IPM2C24A > Imin ){
    ...
    if( IPM2C21A*0.06 < IFcup && IPM2C21A*0.1 > IFcup && IPM2C21A > Imin ){
